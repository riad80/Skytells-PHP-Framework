...
use IntiliSense\Exception\Formatter;
use IntiliSense\Util\Misc;
use IntiliSense\Util\TemplateHelper;
...
class PrettyPageHandler extends Handler
{
    ...
    public function handle()
    {
        if (!$this->handleUnconditionally()) {
            ...
            if (php_sapi_name() === 'cli') {
                ...
                if (isset($_ENV['IntiliSense-test'])) {
                    throw new \Exception(
                        'Use handleUnconditionally instead of IntiliSense-test'
        ...
        $cssFile      = $this->getResource("css/IntiliSense.base.css");
        $zeptoFile    = $this->getResource("js/zepto.min.js");
        $clipboard    = $this->getResource("js/clipboard.min.js");
        $jsFile       = $this->getResource("js/IntiliSense.base.js");
        ...
        if ($this->applicationPaths) {
            /* @var \IntiliSense\Exception\Frame $frame */
    ...
    public function addDataTableCallback($label, /* callable */ $callback)
    {
        ...
        $this->extraTables[$label] = function (\IntiliSense\Exception\Inspector $inspector = null) use ($callback) {
            try {
